 ...
 */
final class Version20260513112225 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart (id INT AUTO_INCREMENT NOT NULL, total_quantity INT NOT NULL, name VARCHAR(255) NOT NULL, is_main TINYINT NOT NULL, total_price NUMERIC(10, 2) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, customer_id INT DEFAULT NULL, INDEX IDX_BA388B79395C3F3 (customer_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE chat_message (id INT AUTO_INCREMENT NOT NULL, content LONGTEXT NOT NULL, is_read TINYINT NOT NULL, created_at DATETIME NOT NULL, sender_id INT NOT NULL, recipient_id INT NOT NULL, INDEX IDX_FAB3FC16F624B39D (sender_id), INDEX IDX_FAB3FC16E92F8F78 (recipient_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE notification (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, message LONGTEXT DEFAULT NULL, type VARCHAR(50) NOT NULL, is_read TINYINT NOT NULL, created_at DATETIME NOT NULL, target_url VARCHAR(255) DEFAULT NULL, recipient_id INT DEFAULT NULL, INDEX IDX_BF5476CAE92F8F78 (recipient_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE reward_transaction (id INT AUTO_INCREMENT NOT NULL, points INT NOT NULL, type VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL, customer_id INT NOT NULL, order_id INT DEFAULT NULL, INDEX IDX_67A2E8039395C3F3 (customer_id), INDEX IDX_67A2E8038D9F6D38 (order_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
