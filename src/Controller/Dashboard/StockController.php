...
{
    #[Route('/', name: 'app_dashboard_stock_index', methods: ['GET'])]
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_dashboard_stock_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/{id}', name: 'app_dashboard_stock_delete', methods: ['POST'])]
